...
public class AlunoCloneTest {
    ...
    void cloneDtNascimentoAttribute() {
        ...
        final Aluno clone = aluno.clone();

        assertEquals(clone.getDtnascimento(), aluno.getDtnascimento());
    }
    ...
    void cloneNomeAttribute() {
        ...
        assertEquals(clone.getNome(), aluno.getNome());
    }
    ...
    void cloneSexoAttribute() {
        ...
        assertEquals(clone.getSexo(), aluno.getSexo());
    }
    ...
    void cloneCodigoAttribute() {
        ...
        assertEquals(clone.getCodigo(), aluno.getCodigo());
    }
    ...
    void cloneNivelAttribute() {
        ...
        assertEquals(clone.getNivel(), aluno.getNivel());
    }
}
